...
// Una volta sistemata la teoria, inserire setInterval in una promise cosi viene esegiuta comunque prima del numero random
...
function mainEngine(obj, dir, cont, selectCoord, topLeft){
  ...
  // let is_same_4;
  const is = [];
  // console.log("is prima : " + is);
  // is_same_1, is_same_2, is_same_3, is_same_4

  ////////////////////////////////////////////////////////////////////

  changeArray(arr, arr_, is, oj, true);  

  // console.log("is dopo : " + is);
