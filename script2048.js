...
function mainEngine(obj, dir, cont, selectCoord, topLeft){
  ...
  for(let k = 0; k < 4; k++){
    ...
    arr_demo[k].forEach( (_,i) => {
      ...
      t[k] = 0;
      let minPoint = s[oj.positions(i,k)[0]].getBoundingClientRect()[dirT_L[topLeft]] - Number(coord[selectCoord]) - 8;
  
        if(arr_demo[k][i - 1] === "&" && arr_demo[k][i - 2] === "&"){
          // console.log("Partito l'if : " + arr_demo[k][i]);
            const interval = setInterval(function(){
            t[k] = t[k] + freq;
            let variation = Number(`${arrS[k][i]}`) - Number(coord[selectCoord]) - 8 - oj.sign()*t[k];
            // scambio array
            minPoint = s[oj.positions(i,k)[2]].getBoundingClientRect()[dirT_L[topLeft]] - Number(coord[selectCoord]) - 8;
            ...
            if(check(variation,minPoint)[cont]) {
              ...
              setNumberSize(Number(arr_demo[k][i] * 2), s[oj.positions(i,k)[2]]);
              setNumberColor(Number(arr_demo[k][i] * 2), s[oj.positions(i,k)[2]]);
              s[oj.positions(i,k)[2]].innerHTML = arr_demo[k][i] * 2;
            };
          },1);
          ...
          const interval = setInterval(function(){
            t[k] = t[k] + freq;
            let variation = Number(`${arrS[k][i]}`) - Number(coord[selectCoord]) - 8 - oj.sign()*t[k];
            minPoint = s[oj.positions(i,k)[1]].getBoundingClientRect()[dirT_L[topLeft]] - Number(coord[selectCoord]) - 8;
            document.querySelector(`.moving-${dirL_R_U_D[dir]}${i + dim[k]}`).style[dirT_L[topLeft]] = `${variation}px`;
  
            if(check(variation,minPoint)[cont]) {
              clearInterval(interval);
              document.querySelector(`.moving-${dirL_R_U_D[dir]}${i + dim[k]}`).remove();
              setNumberSize(Number(arr_demo[k][i + 1]), s[oj.positions(i,k)[1]]);
              setNumberColor(Number(arr_demo[k][i + 1]), s[oj.positions(i,k)[1]]);
              s[oj.positions(i,k)[1]].innerHTML = arr_demo[k][i + 1];
            };
          },1);
          arr_demo[k][i] = "&";
          ...
          const interval = setInterval(function(){
            ...
            if(check(variation,minPoint)[cont]) {
              clearInterval(interval);
              document.querySelector(`.moving-${dirL_R_U_D[dir]}${i + dim[k]}`).remove();
              setNumberSize(Number(arr_demo[k][i]), s[oj.positions(i,k)[1]]);
              setNumberColor(Number(arr_demo[k][i]), s[oj.positions(i,k)[1]]);
              s[oj.positions(i,k)[1]].innerHTML = arr_demo[k][i];
            };
          },1);
          ...
          const interval = setInterval(function(){
            ...
            if(check(variation,minPoint)[cont]) {
              clearInterval(interval);
              document.querySelector(`.moving-${dirL_R_U_D[dir]}${i + dim[k]}`).remove();
              setNumberSize(Number(arr_demo[k][i - 1] * 2), s[oj.positions(i,k)[1]]);
              setNumberColor(Number(arr_demo[k][i - 1] * 2), s[oj.positions(i,k)[1]]);
              s[oj.positions(i,k)[1]].innerHTML = arr_demo[k][i - 1] * 2;
          ...
          // console.log("Partito l'else : " + arr_demo[k][i]);
            ...
            if(check(variation,minPoint)[cont]) {
              clearInterval(interval);
              document.querySelector(`.moving-${dirL_R_U_D[dir]}${i + dim[k]}`).remove();
              setNumberSize(Number(arr_demo[k][i]), s[oj.positions(i,k)[0]]);
              setNumberColor(Number(arr_demo[k][i]), s[oj.positions(i,k)[0]]);
              s[oj.positions(i,k)[0]].innerHTML = arr_demo[k][i];
            };
            },1);
            }
...
function gameOverEngine(){
  ...
  const bb = [];
  s.forEach((e,i) => bb.push(s[i].textContent));
...
function setLeftDemo(){
  ...
  arr1_1.length = 4;
  console.log("arr1_1 left : " + arr1_1);
  for(let i = 0; i < 4; i++) {
  ...
  arr1_2.length = 4;
  console.log("arr1_2 left : " + arr1_2);
  for(let i = 0; i < 4; i++) {
  ...
  arr1_3.length = 4;
  console.log("arr1_3 left : " + arr1_3);
  for(let i = 0; i < 4; i++) {
  ...
  arr1_4.length = 4;
  console.log("arr1_4 left : " + arr1_4);
  for(let i = 0; i < 4; i++) {
...
function setRightDemo(){
  ...
  const arr1_1 = arr1.filter( (e) => Number(e) !== null && Number(e) !== 0);
  arr1_1.length = 4;
  console.log("arr1_1 rigth : " + arr1_1);
  for(let i = 0; i < 4; i++) {
    if(arr1_1[i] === undefined) arr1_1[i] = "";
  }
  const is_same_1 = ((a1.length == arr1_1.length) && a1.every((e, i) => e === arr1_1[i]));
  ...
  const arr1_2 = arr2.filter( (e) => Number(e) !== null && Number(e) !== 0);
  arr1_2.length = 4;
  console.log("arr1_2 rigth : " + arr1_2);
  for(let i = 0; i < 4; i++) {
    if(arr1_2[i] === undefined) arr1_2[i] = "";
  }
  const is_same_2 = ((a2.length == arr1_2.length) && a2.every((e, i) => e === arr1_2[i]));
  ...
  const arr1_3 = arr3.filter( (e) => Number(e) !== null && Number(e) !== 0);
  arr1_3.length = 4;
  console.log("arr1_3 rigth : " + arr1_3);
  for(let i = 0; i < 4; i++) {
    if(arr1_3[i] === undefined) arr1_3[i] = "";
  }
  const is_same_3 = ((a3.length == arr1_3.length) && a3.every((e, i) => e === arr1_3[i]));
  ...
  const arr1_4 = arr4.filter( (e) => Number(e) !== null && Number(e) !== 0);
  arr1_4.length = 4;
  console.log("arr1_4 rigth : " + arr1_4);
  for(let i = 0; i < 4; i++) {
    if(arr1_4[i] === undefined) arr1_4[i] = "";
  }
  const is_same_4 = ((a4.length == arr1_4.length) && a4.every((e, i) => e === arr1_4[i]));
...
window.addEventListener("keydown", function (e) {
  console.log("PARTITA e.key : " + e.key);
  e.preventDefault();

  if(checkGameOver() && gameOverEngine()) {
    //  nascosta.classList.remove("hidden");
    //  console.log("check : " + ccc);
    //  console.log("gameOverEngine() : " + gameOverEngine());
    //  const yyy = ccc && gameOverEngine();
     console.log("checkGameOver() && gameOverEngine() : " + yyy);
